...
test('can create timeline event with label', function () {
    $data = [
        'id' => 12345,
        'event' => 'labeled',
        'actor' => [
...
test('can create timeline event with state', function () {
    $data = [
        'id' => 12345,
        'event' => 'closed',
        'actor' => [
...
test('can create timeline event with commit', function () {
    $data = [
        'id' => 12345,
        'event' => 'committed',
        'actor' => [
...
test('can create timeline event with cross-reference source', function () {
    $data = [
        'id' => 12345,
...
test('can check if timeline event is cross-reference', function () {
...
test('can check if timeline event is commit', function () {
...
test('can check if timeline event is review', function () {
...
test('filters null values from array representation', function () {
    $event = new TimelineEvent(
        id: 12345,
        event: 'closed',
        actor: null,
