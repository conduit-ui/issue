...
describe('IssueEvent', function () {
    it('can create issue event from array', function () {
        $data = [
            'id' => 12345,
            'event' => 'labeled',
            'actor' => [
    ...
    it('can create issue event with null actor', function () {
        $data = [
            'id' => 12345,
            'event' => 'closed',
            'actor' => null,
    ...
    it('can create assigned event', function () {
        $data = [
            'id' => 12345,
            'event' => 'assigned',
            'actor' => [
    ...
    it('can create milestone event', function () {
        $data = [
            'id' => 12345,
            'event' => 'milestoned',
            'actor' => [
    ...
    it('can create commit event', function () {
        $data = [
            'id' => 12345,
            'event' => 'referenced',
            'actor' => [
    ...
    it('can convert issue event to array', function () {
    ...
    it('can check if event is label event', function () {
    ...
    it('can check if event is assignee event', function () {
    ...
    it('can check if event is state event', function () {
        $closedEvent = new IssueEvent(
            id: 1,
            event: 'closed',
            actor: null,
    ...
    it('can check if event is milestone event', function () {
