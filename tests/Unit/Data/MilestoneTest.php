...
test('can create milestone from array with null values', function () {
    $data = [
        'id' => 123,
        'number' => 1,
        'title' => 'v1.0.0',
...
test('can check if milestone is overdue', function () {
...
test('milestone without due date is not overdue', function () {
    $milestone = new Milestone(
        id: 123,
        number: 1,
        title: 'v1.0.0',
...
test('closed milestone is not overdue even if past due date', function () {
    $pastDate = new DateTime('-1 day');
...
test('can calculate completion percentage', function () {
    $milestone = new Milestone(
        id: 123,
        number: 1,
        title: 'v1.0.0',
...
test('completion percentage is zero when no issues', function () {
    $milestone = new Milestone(
        id: 123,
        number: 1,
        title: 'v1.0.0',
...
test('completion percentage is 100 when all issues closed', function () {
    $milestone = new Milestone(
        id: 123,
        number: 1,
        title: 'v1.0.0',
